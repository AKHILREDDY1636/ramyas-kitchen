      ...
      <div className="p-8 md:p-10">
        ...
        <div className="flex gap-3">
          <a
            ...
            className="flex-1 bg-[#25D366] text-white py-3.5 rounded-xl font-semibold hover:bg-[#128C7E] hover:-translate-y-0.5 transition shadow-lg shadow-green-500/30 text-sm xs:text-base"
            style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', lineHeight: 1, whiteSpace: 'nowrap' }}
          >
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
          ...
          <a
            ...
            className="bg-[#3A2418] text-[#F5EFE0] px-4 xs:px-6 py-3.5 rounded-xl font-semibold text-sm xs:text-base hover:bg-[#1F1410] transition"
            style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', lineHeight: 1, whiteSpace: 'nowrap' }}
          >
            📞 Call
          </a>
        </div>
